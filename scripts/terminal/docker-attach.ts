...
type ServerStatus = "ONLINE" | "STOPPING" | "RESTARTING" | "STARTING" | "UNKNOWN";
...
function getStatusColor(status: ServerStatus): string {
    switch (status) {
        case "ONLINE": return "\x1b[42m"; // Green
        case "STOPPING": return "\x1b[43m"; // Yellow (Orange-ish)
        case "RESTARTING": return "\x1b[45m"; // Magenta
        case "STARTING": return "\x1b[44m"; // Blue
        default: return "\x1b[44m"; // Blue (Default)
    }
}
